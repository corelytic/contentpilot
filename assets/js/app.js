(function () {
  ...
  // Rendering always starts from the current route and the latest normalized state.
  function render() {
    ensureSelections();
    renderSidebar();
    renderTopFilters();
    ...
    return (
      ...
      '<section class="panel">' +
        '<div class="panel-header">' +
          ...
          '<div class="inline-actions"><button class="button button-secondary" data-action="open-quick-add">Create Content Item</button><button class="button button-ghost" data-action="open-notifications">Review Blockers</button></div>' +
        '</div>' +
      ...
      '<section class="panel">' +
        ...
        '<div class="three-column">' +
          ...
          '<div class="card"><h4>Backup & Restore</h4><p class="helper-text">Export or import the complete local workspace safely.</p>' +
            '<div class="inline-actions"><button class="button button-secondary" data-action="export-json">Export JSON</button><button class="button button-ghost" data-action="import-json">Import JSON</button></div></div>' +
        ...
        '<div class="panel" style="margin-top:18px;">' +
          ...
          '<ul class="warning-list"><li>All modules work by opening <strong>index.html</strong> directly.</li><li>Data persists in <strong>localStorage</strong> with export, import, overwrite warning, and full reset.</li><li>Reports export as standalone HTML files for stakeholders, clients, or internal archives.</li></ul>' +
        '</div>' +
      ...
      try {
        ...
        openModal(
          ...
          '<div class="stack"><p class="helper-text">This backup contains ' +
            ...
            ' sponsors. Applying it will replace the current workspace.</p><div class="inline-actions"><button class="button button-primary" data-action="apply-import">Apply Import</button><button class="button button-ghost" data-action="close-modal">Cancel</button></div></div>'
        );
      } catch (error) {
  ...
  function buildHtmlReportDocument(title, body) {
    return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>' +
      ...
      '.report-hero{margin-top:0;padding-top:0;border-top:none;padding:28px;border-radius:24px;background:linear-gradient(135deg,#0f1b35,#15284c 55%,#1f3568);color:#f4f8ff}.report-hero h2{font-size:2.05rem;margin-bottom:8px}.report-hero p{max-width:760px;color:#d9e6ff}' +
      '.report-hero-meta{display:flex;gap:10px;flex-wrap:wrap;margin-top:16px}.report-hero-meta span{display:inline-flex;align-items:center;padding:8px 12px;border-radius:999px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);font-size:.82rem}' +
      '.report-metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-top:22px}.report-metric{padding:18px;border:1px solid #e7edf7;border-radius:20px;background:#f8fbff}.report-metric span{display:block;color:#66789d;font-size:.78rem;text-transform:uppercase;letter-spacing:.12em}.report-metric strong{display:block;margin-top:10px;font-size:1.3rem;letter-spacing:-.03em}.report-metric p{margin:10px 0 0;color:#445371;font-size:.95rem}' +
      '.report-bullet-grid,.report-risk-list,.report-recommendations{list-style:none;padding:0;margin:0;display:grid;gap:12px}.report-bullet-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.report-bullet-grid li,.report-risk-list li,.report-recommendations li{padding:14px 16px;border-radius:18px;background:#f8fbff;border:1px solid #e7edf7}.report-bullet-grid li{display:flex;justify-content:space-between;gap:16px;align-items:center}.report-bullet-grid li span{font-weight:700}' +
      '.report-risk-list li{display:grid;grid-template-columns:auto 1fr;gap:12px;align-items:flex-start}.report-risk-list li p{margin:6px 0 0;color:#445371}.report-list-label{display:inline-flex;align-items:center;justify-content:center;padding:7px 10px;border-radius:999px;font-size:.74rem;text-transform:uppercase;letter-spacing:.08em;border:1px solid #e7edf7;background:#fff;height:max-content}.report-list-label.is-danger{color:#c54969;border-color:rgba(197,73,105,.18);background:#fff4f7}.report-list-label.is-warning{color:#b17b16;border-color:rgba(177,123,22,.18);background:#fff9ef}.report-list-label.is-info{color:#3468d0;border-color:rgba(52,104,208,.18);background:#f3f7ff}' +
      'ul{padding-left:20px;line-height:1.7}table{width:100%;border-collapse:collapse;margin-top:10px}th,td{padding:12px 10px;border-bottom:1px solid #e8eef8;vertical-align:top;text-align:left;overflow-wrap:anywhere}th{font-size:12px;text-transform:uppercase;letter-spacing:.12em;color:#66789d;background:#f7f9fd}' +
      ...
      '@media print{body{padding:0;background:#fff}main{box-shadow:none;border-radius:0;padding:28px}.report-hero{background:#fff;color:#14203a;border:1px solid #e7edf7}.report-hero p{color:#445371}.report-hero-meta span{background:#fff;border-color:#e7edf7}}' +
